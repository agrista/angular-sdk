...
interfaceNavigationApp.directive('pageContainer', function () {
    return {
        restrict: 'E',
        replace: true,
        transclude: true,
...
interfaceNavigationApp.directive('pageContent', function () {
    return {
        restrict: 'E',
        replace: true,
        transclude: true,
...
interfaceNavigationApp.directive('pageNotification', ['$timeout', function ($timeout) {
    return {
        restrict: 'E',
        scope: {
            message: '=',
 ...
 */
interfaceNavigationApp.directive('pageNavbar', ['safeApply', function (safeApply) {
    return {
        restrict: 'E',
        scope: {
            title: '=',
