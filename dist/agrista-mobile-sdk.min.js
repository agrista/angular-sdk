...
},{restrict:"E",template:'<div class="map" ng-hide="hidden" ng-transclude></div>',replace:!0,transclude:!0,link:function(a,b,c){void 0===k[c.id]&&(k[c.id]=new j(c,a))},controller:function(a,b){this.getMap=function(){return k[b.id]._map}}}}]),sdkInterfaceMapApp.directive("mapboxControl",["$rootScope",function(a){function b(b){var e=b.parent();a.$on("mapbox-"+e.attr("id")+"::init",function(){e.find(".leaflet-control-container "+d[c]).prepend(b)})}var c,d={topleft:".leaflet-top.leaflet-left",topright:".leaflet-top.leaflet-right",bottomleft:".leaflet-bottom.leaflet-left",bottomright:".leaflet-bottom.leaflet-right"};return{restrict:"E",require:"^mapbox",replace:!0,transclude:!0,template:'<div class="leaflet-control"><div class="leaflet-bar" ng-transclude></div></div>',link:function(a,b,d){c=void 0==d.position?"bottomright":d.position},controller:function(a){b(a)}}}]);var sdkInterfaceNavigiationApp=angular.module("ag.sdk.interface.navigation",["ag.sdk.authorization","ag.sdk.library"]);sdkInterfaceNavigiationApp.provider("navigationService",["underscore",function(a){var b={},c=[],d={Favourites:1,Assets:2,Apps:3,Administration:4},e={left:[],right:[]},f=function(a,b){return a.order-b.order},g=this.registerApps=function(c){c=c instanceof Array?c:[c],angular.forEach(c,function(c){c=a.defaults(c,{id:c.title,order:100,group:"Apps",include:function(a,b){return-1!==b.indexOf(a.id)}}),c.title&&c.state&&(b[c.title]=c)})};this.$get=["$rootScope","$state","authorization",function(h,i,j){var k=!1,l="",m=function(b){var e=a.findWhere(c,{title:b.group});void 0===e&&(e={title:b.group,order:d[b.group]||100,items:[]},c.push(e),c=c.sort(f));var g=a.findWhere(e.items,{id:b.id});void 0===g&&(b.active=i.includes(b.state),e.items.push(b),e.items=e.items.sort(f),h.$broadcast("navigation::items__changed",c),h.$broadcast("navigation::app__allowed",b))},n=function(){c=[],h.$broadcast("navigation::items__changed",c)},o=function(c){var d=c||j.currentUser(),e=d.userRole?a.pluck(d.userRole.apps,"name"):[],f=d.organization?a.pluck(d.organization.services,"serviceType"):[];n(),angular.forEach(b,function(a){("function"==typeof a.include&&a.include(a,e,f)||a.include===!0)&&m(a)})},p=function(a,b){b&&(b instanceof Array==!1?e[a].push(b):e[a]=b,h.$broadcast("navigation::"+a+"-buttons__changed",e[a]),h.$broadcast("navigation::buttons__changed"))};return h.$on("$stateChangeSuccess",function(){angular.forEach(c,function(a){angular.forEach(a.items,function(a){a.active=i.includes(a.state)})})}),h.$on("authorization::login",function(a,b){o(b)}),h.$on("authorization::unauthorized",function(){n()}),h.$on("authorization::logout",function(){n()}),o(),{getGroupedApps:function(){return c},renameApp:function(d,e){var f=a.findWhere(b,{id:d});f&&(f.title=e,h.$broadcast("navigation::items__changed",c))},selectItem:function(a){return h.$broadcast("navigation::item__selected",a),i.go(a)},registerApps:function(a){g(a)},unregisterApps:function(){b={},c=[]},allowApp:function(a){b[a]&&m(b[a])},toggleSlim:function(){k=!k,h.$broadcast("navigation::slim__changed",k)},isSlim:function(){return k},footerText:function(a){return void 0!==a&&(l=a,h.$broadcast("navigation::footerText",l)),l},leftButtons:function(a){return p("left",a),e.left},rightButtons:function(a){return p("right",a),e.right}}}]}]);var sdkInterfaceUiApp=angular.module("ag.sdk.interface.ui",[]);sdkInterfaceUiApp.directive("dynamicName",function(){return{restrict:"A",require:"?form",link:function(a,b,c,d){var e=null!=d?d:b.parent().controller("form"),f=e[b.attr("name")];b.attr("name",c.name),e.$removeControl(f),f.$name=c.name,e.$addControl(f)}}}),sdkInterfaceUiApp.directive("defaultSrc",[function(){return{restrict:"A",link:function(a,b,c){b.bind("error",function(){b.attr("src",c.defaultSrc)})}}}]),sdkInterfaceUiApp.filter("location",["$filter",function(a){return function(b){return(b&&b.geometry?a("number")(b.geometry.coordinates[0],3)+", "+a("number")(b.geometry.coordinates[1],3):"")+(b&&b.properties&&b.properties.accuracy?" at "+a("number")(b.properties.accuracy,2)+"m":"")}}]),sdkInterfaceUiApp.directive("locationFormatter",["$filter",function(a){return{restrict:"A",require:"ngModel",link:function(b,c,d,e){e.$formatters.push(function(c){var e="";return void 0!==c&&(e=a("location")(c),d.ngChange&&b.$eval(d.ngChange)),e})}}}]),sdkInterfaceUiApp.directive("dateFormatter",["$filter",function(a){return{restrict:"A",require:"ngModel",link:function(b,c,d,e){e.$formatters.push(function(b){return void 0!==b?a("date")(new Date(b),d.dateFormat||"yyyy-MM-dd"):""})}}}]),sdkInterfaceUiApp.directive("dateParser",["$filter",function(a){return{restrict:"A",require:"ngModel",link:function(b,c,d,e){e.$parsers.push(function(b){return void 0!==b?a("date")(new Date(b),d.dateFormat||"yyyy-MM-dd"):""})}}}]),sdkInterfaceUiApp.directive("inputNumber",["$filter",function(a){return{restrict:"A",require:"ngModel",link:function(b,c,d,e){var f=d.max?parseFloat(d.max):!1,g=d.min?parseFloat(d.min):!1,h=d.round?parseInt(d.round):!1;e.$formatters.push(function(b){return h===!1?b:a("number")(b,h)}),e.$parsers.push(function(a){var b=isNaN(a);if(e.$setValidity("number",b===!1),b===!1){var c=parseFloat(a);return e.$setValidity("range",(g===!1||c>=g)&&(f===!1||f>=c)),c}return a})}}}]);var cordovaHelperApp=angular.module("ag.mobile-sdk.helper",["ag.sdk.utilities","ag.mobile-sdk.cordova.geolocation","ag.mobile-sdk.cordova.camera"]);cordovaHelperApp.factory("geolocationHelper",["promiseService","geolocationService",function(a,b){function c(a){return this instanceof c?(this._options=a.options||{},this._onGet=a.onGet||angular.noop,this._onWatch=a.onWatch||angular.noop,this._onError=a.onError||angular.noop,void(this._watcher=null)):new c(a)}function d(a){return{type:"Feature",geometry:{coordinates:[a.coords.longitude,a.coords.latitude],type:"Point"},properties:{accuracy:a.coords.accuracy,altitude:a.coords.altitude}}}return c.prototype={busy:!1,getPosition:function(a){var c=this;c.busy=!0,a=a||c._options,b.getPosition(a).then(function(a){c.busy=!1,c._onGet(d(a),a)},function(a){c.busy=!1,c._onError(a)})},watchPosition:function(a){var c=this;a=a||c._options,c._watcher=b.watchPosition(a,function(a,b){a?c._onWatch(d(a),a):c._onError(b)})},cancelWatch:function(){this._watcher&&(this._watcher.cancel(),this._watcher=null)}},function(a){return new c(a)}}]),cordovaHelperApp.factory("cameraHelper",["promiseService","geolocationService","cameraService",function(a,b,c){var d={geolocation:{enableHighAccuracy:!0,timeout:3e4},camera:{quality:40,targetWidth:960,targetHeight:540,correctOrientation:!0,encodingType:c.getEncodingTypes.JPEG,destinationType:c.getDestinationTypes.FILE_URI}},e={0:"image/jpeg",1:"image/png"};return{capturePhotoWithLocation:function(f,g){return f=f||d.geolocation,g=g||d.camera,a.wrap(function(d){a.all({geolocation:b.getPosition(f),camera:c.capture(g)}).then(function(a){d.resolve({geolocation:{type:"Feature",geometry:{coordinates:[a.geolocation.coords.longitude,a.geolocation.coords.latitude],type:"Point"},properties:{source:"gps",accuracy:a.geolocation.coords.accuracy,altitude:a.geolocation.coords.altitude}},camera:{src:a.camera,type:e[g.encodingType]}})},d.reject)})}}}]),cordovaHelperApp.factory("mapLocationService",["$rootScope","$timeout","geolocationService","safeApply","underscore",function(a,b,c,d,e){return function(f,g){var h=null,i=null,j=null,k=null,l=g||{},m=!1,n=null,o=function(){m===!1&&(l=e.defaults(g||{},{enableHighAccuracy:!0,maximumAge:3e4,timeout:6e4,setView:!0}),m=!0,i=c.watchPosition(l,s))},p=function(a){a&&(null===k&&(k={position:L.circleMarker([a.latitude,a.longitude],{color:"#4d90fe",opacity:1,fill:!0,fillOpacity:1,clickable:!1}),accuracy:L.circle([a.latitude,a.longitude],a.accuracy,{color:"#4d90fe",weight:3,fill:!1,clickable:!1})},k.position.setRadius(7)),k.position.addTo(j),k.accuracy.addTo(j))},q=function(a){a&&(k.position.setLatLng([a.latitude,a.longitude]),k.accuracy.setLatLng([a.latitude,a.longitude]),k.accuracy.setRadius(a.accuracy),k.position.bringToFront(),k.accuracy.bringToBack(),l.setView&&j.setView(k.position.getLatLng(),15))},r=function(){m&&(m=!1,k&&(j.removeLayer(k.position),j.removeLayer(k.accuracy),k=null,h=null),i.cancel())},s=function(a){d(function(){a&&a.coords&&j&&(null===k&&p(a.coords),q(a.coords),h=a.coords)})};return a.$on("mapbox-"+f.getId()+"::init",function(a,b){j=b,m&&(p(h),q(h))}),f.addEventHandler(["dragstart"],function(){l.setView=!1}),{isActive:function(){return m},cancel:function(){r()},toggleActive:function(){b.cancel(n),n=b(function(){m?r():o()},300)}}}}]);var sdkTestDataApp=angular.module("ag.sdk.test.data",["ag.sdk.utilities","ag.sdk.id","ag.sdk.library"]);sdkTestDataApp.provider("mockDataService",["underscore",function(a){var b={},c={localStore:!0};this.config=function(b){c=a.defaults(b,c)},this.$get=["localStore","objectId","promiseService",function(d,e,f){return c.localStore&&(b=d.getItem("mockdata")||{}),{setItem:function(a,f){f instanceof Array?(b[a]={},angular.forEach(f,function(c){c.id=c.id||e().toString(),b[a][c.id]=c})):(f.id=f.id||e().toString(),b[a]=b[a]||{},b[a][f.id]=f),c.localStore&&d.setItem("mockdata",b)},getItem:function(c,d){return f.wrap(function(e){b[c]=b[c]||{},void 0===d?e.resolve(a.toArray(b[c]||{})):b[c][d]?e.resolve(b[c][d]):e.reject()})}}}]}]);var cordovaCameraApp=angular.module("ag.mobile-sdk.cordova.camera",["ag.sdk.utilities","ag.sdk.library","ag.mobile-sdk.cordova.storage"]);cordovaCameraApp.factory("cameraService",["fileStorageService","promiseService","underscore",function(a,b,c){function d(c){var d=b.defer();return void 0!==navigator.camera?navigator.camera.getPicture(function(b){c.destinationType===f.FILE_URI?a.move(b,"photos").then(function(a){d.resolve(a.path)}):d.resolve(b)},function(a){d.reject(a)},c):d.reject({code:"NoCamera",message:"No camera available"}),d.promise}"undefined"==typeof window.Camera&&(window.Camera={});var e=Camera.PictureSourceType,f=Camera.DestinationType,g=Camera.EncodingType;return{getDestinationTypes:f,getEncodingTypes:g,getPictureSourceTypes:e,capture:function(a){return"object"!=typeof a&&(a={}),d(c.defaults(a,{quality:50,destinationType:f.DATA_URL,source:e.CAMERA}))},captureAndEdit:function(a){return"object"!=typeof a&&(a={}),d(c.defaults(a,{quality:50,allowEdit:!0,destinationType:f.DATA_URL,source:e.CAMERA}))},retrieve:function(a){return"object"!=typeof a&&(a={}),d(c.defaults(a,{quality:50,destinationType:f.FILE_URI,source:e.PHOTOLIBRARY}))}}}]);var cordovaConnectionApp=angular.module("ag.mobile-sdk.cordova.connection",["ag.sdk.library"]);cordovaConnectionApp.factory("connectionService",["$timeout","underscore",function(a,b){var c=[],d=void 0,e=void 0,f=function(){a.cancel(e),navigator.connection&&d!==navigator.connection.type&&(d=navigator.connection.type,angular.forEach(c,function(a){a(d)})),e=a(f,1e4)};return{watchConnection:function(g){return"function"==typeof g&&(c.push(g),g(d),f()),{cancel:function(){c=b.without(c,g),0==c.length&&a.cancel(e)}}},isOnline:function(){return navigator.connection&&navigator.connection.type!==Connection.NONE&&navigator.connection.type!==Connection.UNKNOWN},isMobile:function(){return navigator.connection&&(navigator.connection.type===Connection.CELL||navigator.connection.type===Connection.CELL_2G||navigator.connection.type===Connection.CELL_3G||navigator.connection.type===Connection.CELL_4G)}}}]);var cordovaGeolocationApp=angular.module("ag.mobile-sdk.cordova.geolocation",["ag.sdk.utilities","ag.sdk.library"]);cordovaGeolocationApp.factory("geolocationService",["promiseService","underscore",function(a,b){function c(a,b){switch(a){case PositionError.PERMISSION_DENIED:return f.PermissionDenied;case PositionError.POSITION_UNAVAILABLE:return f.PositionUnavailable;case PositionError.TIMEOUT:return f.Timeout;default:return{err:"Unknown",msg:b}}}var d=navigator.geolocation,e={enableHighAccuracy:!0},f={PermissionDenied:{err:"PermissionDenied",msg:"Not authorizated to request position"},PositionUnavailable:{err:"PositionUnavailable",msg:"Unable to receive position"},Timeout:{err:"Timeout",msg:"Unable to receive position within timeout"},Unknown:{err:"Unknown",msg:"An unknown error occured"}};return{getPosition:function(f){"object"!=typeof f&&(f={}),f=b.defaults(f,e);var g=a.defer();return d.getCurrentPosition(function(a){g.resolve(a)},function(a){g.reject(c(a.code,a.msg))},f),g.promise},watchPosition:function(a,f){function g(){var b=void 0;this.start=function(){void 0===b&&(b=d.watchPosition(function(a){f(a)},function(a){f(null,c(a.code,a.msg))},a))},this.cancel=function(){void 0!==b&&(d.clearWatch(b),b=void 0)},this.start()}return"function"==typeof a&&(f=a,a={}),"object"!=typeof a&&(a={}),a=b.defaults(a,e),new g}}}]);var cordovaStorageApp=angular.module("ag.mobile-sdk.cordova.storage",["ag.sdk.utilities"]);cordovaStorageApp.factory("fileStorageService",["$log","promiseService",function(a,b){var c=void 0,d={noFileSystem:{err:"NoFileSystem",msg:"Could not initialize file system"},directoryNotFound:{err:"directoryNotFound",msg:"Could not find requested directory"},fileNotFound:{err:"FileNotFound",msg:"Could not find requested file"},fileNotReadable:{err:"FileNotReadable",msg:"Could not read from file"},fileNotWritable:{err:"FileNotWritable",msg:"Could not write to file"}},e=function(a,b){void 0===c?window.requestFileSystem(LocalFileSystem.PERSISTENT,0,function(b){c=b,a()},b):a()},f=function(a,f){var g=b.defer(),h=function(a){g.resolve(a)},i=function(){g.reject(d.fileNotFound)};return e(function(){0===a.indexOf("file://")?window.resolveLocalFileSystemURI(a,h,i):c.root.getFile(a,f,h,i)},function(){g.reject(d.noFileSystem)}),g.promise};return a.debug("Initialized storageService"),{exists:function(a){var c=b.defer();return f(a,{create:!1}).then(function(a){c.resolve({exists:!0,file:a.name})},function(a){c.reject(a)}),c.promise},read:function(a,c){var e=b.defer();return f(a,{create:!1}).then(function(a){a.file(function(b){var f=new FileReader;f.onloadend=function(){e.resolve({read:!0,file:a.name,content:f.result})},f.onerror=function(){e.reject(d.fileNotReadable)},c===!0?f.readAsDataURL(b):f.readAsText(b)},function(){e.reject(d.fileNotFound)})},function(a){e.reject(a)}),e.promise},copy:function(a,e){var g=b.defer();return f(a,{create:!1}).then(function(a){var b=a.name.replace(/^([^.]+)/,(new Date).getTime());c.root.getDirectory(e,{create:!0,exclusive:!1},function(c){a.copyTo(c,b,function(a){g.resolve({copy:!0,file:a.name,path:a.toURL()})},function(){g.reject(d.fileNotFound)})},function(){g.reject(d.directoryNotFound)})},function(a){g.reject(a)}),g.promise},move:function(a,e){var g=b.defer();return f(a,{create:!1}).then(function(a){var b=a.name.replace(/^([^.]+)/,(new Date).getTime());c.root.getDirectory(e,{create:!0,exclusive:!1},function(c){a.moveTo(c,b,function(a){g.resolve({move:!0,file:a.name,path:a.toURL()})},function(){g.reject(d.fileNotFound)})},function(){g.reject(d.directoryNotFound)})},function(a){g.reject(a)}),g.promise},write:function(a,c){var e=b.defer();return f(a,{create:!0}).then(function(a){a.createWriter(function(b){b.onwriteend=function(){e.resolve({write:!0,file:a.name})},b.onerror=function(){e.reject(d.fileNotWritable)},b.write(c)},function(){e.reject(d.fileNotFound)})},function(a){e.reject(a)}),e.promise},remove:function(a){var c=b.defer();return f(a,{create:!1}).then(function(a){a.remove(function(){c.resolve({remove:!0,file:a.name})},function(){c.reject(d.fileNotFound)})},function(a){c.reject(a)}),c.promise}}}]);var cordovaToasterApp=angular.module("ag.mobile-sdk.cordova.toaster",[]);cordovaToasterApp.factory("toasterService",[function(){var a=function(a,b,c){var d=window.plugins&&window.plugins.toast?window.plugins.toast:void 0;void 0!==d&&d.show(a,b,c)};return{show:function(b,c,d){a(b,c,d)},showLongBottom:function(b){a(b,"long","bottom")}}}]);var mobileSdkApiApp=angular.module("ag.mobile-sdk.api",["ag.sdk.utilities","ag.sdk.monitor","ag.mobile-sdk.hydration","ag.mobile-sdk.data","ag.mobile-sdk.cordova.connection","ag.mobile-sdk.cordova.storage","ag.sdk.library"]),_errors={TypeParamRequired:{code:"TypeParamRequired",message:"Type parameter is required"},UploadPhotoError:{code:"UploadPhotoError",message:"Error occured uploading photo"}};mobileSdkApiApp.provider("apiSynchronizationService",["underscore",function(a){var b={models:["budgets","documents","expenses","farmers","tasks","organizational-units"],local:{readLocal:!0,hydrate:!1},remote:{readLocal:!1,readRemote:!0,hydrate:!1}},c=!1;this.config=function(c){b=a.extend(b,c)},this.$get=["$http","$log","assetApi","configuration","connectionService","documentApi","enterpriseBudgetApi","expenseApi","farmApi","farmerApi","fileStorageService","legalEntityApi","organizationalUnitApi","pagingService","promiseService","taskApi",function(a,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r){function s(a){return a=a||{limit:20,resulttype:"simple"},l.purgeFarmer({template:"farmers",options:{force:!1}}).then(function(){return q.wrap(function(c){var d=p.initialize(function(a){return l.getFarmers({params:a,options:b.remote})},function(){d.complete?c.resolve():d.request().catch(c.reject)},a);d.request().catch(c.reject)})})}function t(a){return a=a||{limit:20,resulttype:"simple"},h.purgeDocument({template:"documents",options:{force:!1}}).then(function(){return q.wrap(function(c){var d=p.initialize(function(a){return h.getDocuments({params:a,options:b.remote})},function(){d.complete?c.resolve():d.request().catch(c.reject)},a);d.request().catch(c.reject)})})}function u(a){return a=a||{limit:20,resulttype:"full"},j.purgeExpense({template:"expenses",options:{force:!1}}).then(function(){return q.wrap(function(c){var d=p.initialize(function(a){return j.getExpenses({params:a,options:b.remote})},function(){d.complete?c.resolve():d.request().catch(c.reject)},a);d.request().catch(c.reject)})})}function v(a){return a=a||{limit:20,resulttype:"simple"},r.purgeTask({template:"tasks",options:{force:!1}}).then(function(){return q.wrap(function(c){var d=p.initialize(function(a){return r.getTasks({params:a,options:b.remote})},function(a){q.chain(function(b){angular.forEach(a,function(a){b.push(function(){return r.findTask({key:a.id,options:{fallbackRemote:!0,hydrate:["organization","subtasks"]}})})})}).then(function(){d.complete?c.resolve():d.request().catch(c.reject)})},a);d.request().catch(c.reject)})})}function w(){return i.getEnterpriseBudgets({options:b.remote})}function x(a){return a=a||{limit:20,resulttype:"simple"},o.purgeOrganizationalUnit({template:"organizational-units",options:{force:!1}}).then(function(){return q.wrap(function(c){var d=p.initialize(function(a){return o.getOrganizationalUnits({params:a,options:b.remote})},function(){d.complete?c.resolve():d.request().catch(c.reject)},a);d.request().catch(c.reject)})})}function y(){return l.getFarmers({options:{readLocal:!0,hydrate:["primaryContact"]}}).then(function(a){return q.chain(function(b){angular.forEach(a,function(a){b.push(function(){return z(a)})})})},q.throwError)}function z(a){return q.chain(function(b){a.__dirty===!0&&b.push(function(){return l.postFarmer({data:a})}),b.push(function(){return A(a.id)},function(){return B(a.id)})})}function A(a){return k.getFarms({id:a,options:b.local}).then(function(a){return q.chain(function(b){angular.forEach(a,function(a){a.__dirty===!0&&b.push(function(){return k.postFarm({data:a})})})})},q.throwError)}function B(a){return n.getEntities({id:a,options:b.local}).then(function(a){return q.chain(function(b){angular.forEach(a,function(a){a.__dirty===!0&&b.push(function(){return n.postEntity({data:a})}),b.push(function(){return C(a.id)})})})},q.throwError)}function C(a){return e.getAssets({id:a,options:b.local}).then(function(a){return q.chain(function(b){angular.forEach(a,function(a){a.__dirty===!0&&b.push(function(){return e.postAsset({data:a})})})})},q.throwError)}function D(){return h.getDocuments({options:b.local}).then(function(a){return q.chain(function(b){angular.forEach(a,function(a){a.__dirty===!0&&b.push(function(){return h.postDocument({data:a})})})})},q.throwError)}function E(){return j.getExpenses({options:b.local}).then(function(a){return q.chain(function(b){angular.forEach(a,function(a){a.__dirty===!0&&b.push(function(){return j.postExpense({data:a})})})})},q.throwError)}function F(a){var c=void 0!==a?{template:"tasks/:id",schema:{id:a.id},options:b.local}:{options:b.local};return r.getTasks(c).then(function(b){return q.chain(function(c){angular.forEach(b,function(b){void 0===a?c.push(function(){return F(b)}):b.__dirty===!0&&c.push(function(){return r.postTask({data:b})})}),a&&a.__dirty===!0&&c.push(function(){return r.postTask({data:a})})})},q.throwError)}return{isSynchronizing:function(){return c},synchronize:function(a){var c=this;return a=a||b.models,c.upload(a).then(function(){return c.download(a)})},upload:function(a){return a=a||b.models,q.wrap(function(b){c?b.reject({data:{message:"Syncing with server. Please wait"}}):0==g.isOnline()?b.reject({data:{message:"Cannot connect to the server. Please try again later"}}):(c=!0,q.chain(function(b){-1!==a.indexOf("farmers")&&b.push(y),-1!==a.indexOf("documents")&&b.push(D),-1!==a.indexOf("tasks")&&b.push(F),-1!==a.indexOf("expenses")&&b.push(E)}).then(function(a){c=!1,b.resolve(a)},function(a){c=!1,b.reject(a)}))})},download:function(a){return a=a||b.models,q.wrap(function(b){c?b.reject({data:{message:"Syncing with server. Please wait"}}):0==g.isOnline()?b.reject({data:{message:"Cannot connect to the server. Please try again later"}}):(c=!0,q.chain(function(b){-1!==a.indexOf("farmers")&&b.push(s),-1!==a.indexOf("documents")&&b.push(t),-1!==a.indexOf("tasks")&&b.push(v),-1!==a.indexOf("budgets")&&b.push(w),-1!==a.indexOf("expenses")&&b.push(u),-1!==a.indexOf("organizational-units")&&b.push(x)}).then(function(a){c=!1,b.resolve(a)},function(a){c=!1,b.reject(a)}))})}}}]}]),mobileSdkApiApp.constant("apiConstants",{MissingParams:{code:"MissingParams",message:"Missing parameters for api call"}}),mobileSdkApiApp.factory("api",["apiConstants","dataStore","promiseService","underscore",function(a,b,c,d){return function(e){"String"==typeof e&&(e={singular:e,plural:e+"s"}),void 0===e.plural&&(e.plural=e.singular+"s");var f=b(e.singular,{apiTemplate:e.singular+"/:id",hydrate:e.hydrate,dehydrate:e.dehydrate}),g=function(a){return e.strip?d.omit(a,e.strip):a};return{getItems:function(a){return a=a?angular.copy(a):{},a.options=d.defaults(a.options||{},{one:!1}),f.transaction().then(function(b){return a.template?b.getItems({template:a.template,schema:a.schema,options:a.options,params:a.params}):a.search?(a.options.readLocal=!1,a.options.readRemote=!0,b.getItems({template:e.plural+"?search=:query",schema:{query:a.search},options:a.options,params:a.params})):b.getItems(a.id?{template:e.plural+"/:id",schema:{id:a.id},options:a.options,params:a.params}:{template:e.plural,options:a.options,params:a.params})})},createItem:function(b){return b=b?angular.copy(b):{},f.transaction().then(function(d){return b.data?d.createItems({template:b.template,schema:b.schema,data:b.data,options:b.options}):void c.throwError(a.MissingParams)})},getItem:function(b){return b=b?angular.copy(b):{},f.transaction().then(function(d){return b.id?d.getItems({template:b.template,schema:{id:b.id},options:b.options}):void c.throwError(a.MissingParams)})},findItem:function(b){return b=b?angular.copy(b):{},f.transaction().then(function(d){return b.key?d.findItems({key:b.key,column:b.column,options:b.options}):void c.throwError(a.MissingParams)})},updateItem:function(b){return b=b?angular.copy(b):{},f.transaction().then(function(d){return b.data?d.updateItems({data:g(b.data),options:b.options}):void c.throwError(a.MissingParams)})},postItem:function(b){return b=b?angular.copy(b):{},f.transaction().then(function(d){return b.data?d.postItems({template:b.template,schema:b.schema,data:g(b.data),options:b.options}):void c.throwError(a.MissingParams)})},deleteItem:function(b){return b=b?angular.copy(b):{},f.transaction().then(function(d){return b.data?d.removeItems({template:e.singular+"/:id/delete",data:b.data}):void c.throwError(a.MissingParams)})},purgeItem:function(a){return a=a?angular.copy(a):{},f.transaction().then(function(b){return b.purgeItems({template:a.template,schema:a.schema,options:a.options})})}}}}]),mobileSdkApiApp.factory("userApi",["api",function(a){var b=a({plural:"users",singular:"user"});return{getUsers:b.getItems,createUser:b.createItem,getUser:b.getItem,findUser:b.findItem,updateUser:b.updateItem,postUser:b.postItem,deleteUser:b.deleteItem}}]),mobileSdkApiApp.factory("organizationalUnitApi",["api",function(a){var b=a({plural:"organizational-units",singular:"organizational-unit"});return{getOrganizationalUnits:b.getItems,createOrganizationalUnit:b.createItem,getOrganizationalUnit:b.getItem,findOrganizationalUnit:b.findItem,updateOrganizationalUnit:b.updateItem,postOrganizationalUnit:b.postItem,deleteOrganizationalUnit:b.deleteItem,purgeOrganizationalUnit:b.purgeItem}}]),mobileSdkApiApp.factory("notificationApi",["api",function(a){var b=a({plural:"notifications",singular:"notification"});return{getNotifications:b.getItems,getNotification:b.getItem,deleteNotification:b.deleteItem}}]),mobileSdkApiApp.provider("taskApi",["hydrationProvider",function(a){a.registerHydrate("subtasks",["taskApi",function(a){return function(b){return a.getTasks({template:"tasks/:id",schema:{id:b.__id}})}}]),a.registerDehydrate("subtasks",["taskApi","promiseService",function(a,b){return function(c){var d=void 0!==c.__id?c.__id:c.id;return a.purgeTask({template:"tasks/:id",schema:{id:d},options:{force:!1}}).then(function(){return b.arrayWrap(function(b){angular.forEach(c.subtasks,function(e){b.push(a.createTask({template:"tasks/:id",schema:{id:d},data:e,options:{replace:c.__complete,complete:c.__complete,dirty:!1}}))})})},b.throwError)}}]),this.$get=["api","hydration",function(a,b){var c=["document","organization","subtasks"],d=["document","subtasks"],e=a({plural:"tasks",singular:"task",strip:c,hydrate:function(a,d){return d.hydrate=d.hydrate instanceof Array?d.hydrate:d.hydrate===!0?c:[],b.hydrate(a,"task",d)},dehydrate:function(a,c){return c.dehydrate=c.dehydrate instanceof Array?c.dehydrate:c.dehydrate===!1?[]:d,b.dehydrate(a,"task",c)}});return{getTasks:e.getItems,createTask:e.createItem,getTask:e.getItem,findTask:e.findItem,updateTask:e.updateItem,postTask:e.postItem,deleteTask:e.deleteItem,purgeTask:e.purgeItem}}]}]),mobileSdkApiApp.factory("merchantApi",["api",function(a){var b=a({plural:"merchants",singular:"merchant"});return{getMerchants:b.getItems,createMerchant:b.createItem,getMerchant:b.getItem,updateMerchant:b.updateItem,postMerchant:b.postItem,deleteMerchant:b.deleteItem}}]),mobileSdkApiApp.provider("farmerApi",["hydrationProvider",function(a){a.registerHydrate("organization",["farmerApi",function(a){return function(b,c,d){return a.findFarmer({key:b.organizationId,options:{one:!0,hydrateRemote:d.remoteHydration}})}}]),a.registerDehydrate("organization",["farmerApi","promiseService",function(a,b){return function(c){return b.wrap(function(b){c.organization?(c.organization.id=c.organization.id||c.organizationId,a.createFarmer({template:"farmers",data:c.organization,options:{replace:c.__complete,complete:c.__complete,dirty:!1}}).then(b.resolve,b.reject)):b.resolve(c)})}}]),this.$get=["api","hydration",function(a,b){var c=["farms","legalEntities","primaryContact"],d=a({plural:"farmers",singular:"farmer",strip:["farms","legalEntities"],hydrate:function(a,d){return d.hydrate=d.hydrate instanceof Array?d.hydrate:d.hydrate===!0?c:[],b.hydrate(a,"farmer",d)},dehydrate:function(a,d){return d.dehydrate=d.dehydrate instanceof Array?d.dehydrate:d.dehydrate===!1?[]:c,b.dehydrate(a,"farmer",d)}});return{getFarmers:d.getItems,createFarmer:d.createItem,getFarmer:d.getItem,findFarmer:d.findItem,updateFarmer:d.updateItem,postFarmer:d.postItem,deleteFarmer:d.deleteItem,purgeFarmer:d.purgeItem}}]}]),mobileSdkApiApp.provider("legalEntityApi",["hydrationProvider",function(a){a.registerHydrate("legalEntity",["legalEntityApi",function(a){return function(b,c,d){return a.findEntity({key:b.legalEntityId,options:{one:!0,hydrate:!0,hydrateRemote:d.remoteHydration}})}}]),a.registerHydrate("legalEntities",["legalEntityApi",function(a){return function(b){return a.getEntities({id:b.__id,options:{hydrate:!0}})}}]),a.registerHydrate("primaryContact",["legalEntityApi","underscore",function(a,b){return function(c){return a.getEntities({id:c.__id}).then(function(a){return b.findWhere(a,{isPrimary:!0})})}}]),a.registerDehydrate("legalEntities",["legalEntityApi","promiseService",function(a,b){return function(c){var d=void 0!==c.__id?c.__id:c.id;return a.purgeEntity({template:"legalentities/:id",schema:{id:d},options:{force:!1}}).then(function(){return b.arrayWrap(function(b){angular.forEach(c.legalEntities,function(e){b.push(a.createEntity({template:"legalentities/:id",schema:{id:d},data:e,options:{replace:c.__complete,complete:c.__complete,dirty:!1}}))})})},b.throwError)}}]),this.$get=["api","hydration",function(a,b){var c=["assets"],d=a({plural:"legalentities",singular:"legalentity",strip:c,hydrate:function(a,d){return d.hydrate=d.hydrate instanceof Array?d.hydrate:d.hydrate===!0?c:[],b.hydrate(a,"legalentity",d)},dehydrate:function(a,d){return d.dehydrate=d.dehydrate instanceof Array?d.dehydrate:d.dehydrate===!1?[]:c,b.dehydrate(a,"legalentity",d)}});return{getEntities:d.getItems,createEntity:d.createItem,getEntity:d.getItem,findEntity:d.findItem,updateEntity:d.updateItem,postEntity:d.postItem,deleteEntity:d.deleteItem,purgeEntity:d.purgeItem}}]}]),mobileSdkApiApp.provider("farmApi",["hydrationProvider",function(a){a.registerHydrate("farm",["farmApi",function(a){return function(b,c,d){return a.findFarm({key:b.farmId,options:{one:!0,hydrateRemote:d.remoteHydration}})}}]),a.registerHydrate("farms",["farmApi",function(a){return function(b){return a.getFarms({id:b.__id})}}]),a.registerDehydrate("farms",["farmApi","promiseService",function(a,b){return function(c){var d=void 0!==c.__id?c.__id:c.id;return a.purgeFarm({template:"farms/:id",schema:{id:d},options:{force:!1}}).then(function(){return b.arrayWrap(function(b){angular.forEach(c.farms,function(e){b.push(a.createFarm({template:"farms/:id",schema:{id:d},data:e,options:{replace:c.__complete,complete:c.__complete,dirty:!1}}))})})},b.throwError)}}]),this.$get=["api","hydration",function(a){var b=a({plural:"farms",singular:"farm"});return{getFarms:b.getItems,createFarm:b.createItem,getFarm:b.getItem,findFarm:b.findItem,updateFarm:b.updateItem,postFarm:b.postItem,deleteFarm:b.deleteItem,purgeFarm:b.purgeItem}}]}]),mobileSdkApiApp.provider("assetApi",["hydrationProvider",function(a){a.registerHydrate("assets",["assetApi",function(a){return function(b){return a.getAssets({id:b.__id})}}]),a.registerDehydrate("assets",["assetApi","promiseService",function(a,b){return function(c){var d=void 0!==c.__id?c.__id:c.id;return a.purgeAsset({template:"assets/:id",schema:{id:d},options:{force:!1}}).then(function(){return b.arrayWrap(function(b){angular.forEach(c.assets,function(e){b.push(a.createAsset({template:"assets/:id",schema:{id:d},data:e,options:{replace:c.__complete,complete:c.__complete,dirty:!1}}))})})},b.throwError)}}]),this.$get=["api","hydration",function(a,b){var c=a({plural:"assets",singular:"asset",strip:["farm","legalEntity"],hydrate:function(a,c){return c.hydrate=c.hydrate instanceof Array?c.hydrate:[],b.hydrate(a,"asset",c)},dehydrate:function(a,c){return c.dehydrate=c.dehydrate instanceof Array?c.dehydrate:[],b.dehydrate(a,"asset",c)}});return{getAssets:c.getItems,createAsset:c.createItem,getAsset:c.getItem,findAsset:c.findItem,updateAsset:c.updateItem,postAsset:c.postItem,deleteAsset:c.deleteItem,purgeAsset:c.purgeItem}}]}]),mobileSdkApiApp.provider("documentApi",["hydrationProvider",function(a){a.registerHydrate("document",["documentApi",function(a){return function(b,c,d){return a.findDocument({key:b.documentId,options:{one:!0,hydrateRemote:d.remoteHydration}})}}]),a.registerDehydrate("document",["documentApi",function(a){return function(b){return a.createDocument({template:"documents",data:b.document,options:{replace:b.__complete,complete:b.__complete,dirty:!1}})
}}]),this.$get=["api","hydration",function(a,b){var c=["organization"],d=[],e=a({plural:"documents",singular:"document",strip:["organization","tasks"],hydrate:function(a,d){return d.hydrate=d.hydrate instanceof Array?d.hydrate:d.hydrate===!0?c:[],b.hydrate(a,"document",d)},dehydrate:function(a,c){return c.dehydrate=c.dehydrate instanceof Array?c.dehydrate:c.dehydrate===!1?[]:d,b.dehydrate(a,"document",c)}});return{getDocuments:e.getItems,createDocument:e.createItem,getDocument:e.getItem,findDocument:e.findItem,updateDocument:e.updateItem,postDocument:e.postItem,deleteDocument:e.deleteItem,purgeDocument:e.purgeItem}}]}]),mobileSdkApiApp.factory("activityApi",["api",function(a){var b=a({plural:"activities",singular:"activity"});return{getActivities:b.getItems,createActivity:b.createItem,getActivity:b.getItem,deleteActivity:b.deleteItem}}]),mobileSdkApiApp.factory("enterpriseBudgetApi",["api",function(a){var b=a({plural:"budgets",singular:"budget"});return{getEnterpriseBudgets:b.getItems,createEnterpriseBudget:b.createItem,getEnterpriseBudget:b.getItem,findEnterpriseBudget:b.findItem,updateEnterpriseBudget:b.updateItem,postEnterpriseBudget:b.postItem,deleteEnterpriseBudget:b.deleteItem,purgeEnterpriseBudget:b.purgeItem}}]),mobileSdkApiApp.factory("expenseApi",["api","hydration","promiseService","underscore",function(a,b,c,d){var e=["document","organization"],f=a({plural:"expenses",singular:"expense",strip:["document","organization","user"],hydrate:function(a,c){return c.hydrate=c.hydrate instanceof Array?c.hydrate:c.hydrate===!0?e:[],b.hydrate(a,"expense",c)},dehydrate:function(a,b){return c.wrap(function(c){c.resolve(d.omit(a,b.dehydrate||e))})}});return{getExpenses:f.getItems,createExpense:f.createItem,getExpense:f.getItem,findExpense:f.findItem,updateExpense:f.updateItem,postExpense:f.postItem,purgeExpense:f.purgeItem}}]),mobileSdkApiApp.factory("pipGeoApi",["$http","promiseService","configuration",function(a,b,c){var d=c.getServer();return{getFieldPolygon:function(c,e){return b.wrap(function(b){a.get(d+"api/geo/field-polygon?x="+c+"&y="+e,{withCredentials:!0}).then(function(a){b.resolve(a.data)},b.reject)})},getPortionPolygon:function(c,e){return b.wrap(function(b){a.get(d+"api/geo/portion-polygon?x="+c+"&y="+e,{withCredentials:!0}).then(function(a){b.resolve(a.data)},b.reject)})},getDistrictPolygon:function(c,e){return b.wrap(function(b){a.get(d+"api/geo/district-polygon?x="+c+"&y="+e,{withCredentials:!0}).then(function(a){b.resolve(a.data)},b.reject)})},getProvincePolygon:function(c,e){return b.wrap(function(b){a.get(d+"api/geo/province-polygon?x="+c+"&y="+e,{withCredentials:!0}).then(function(a){b.resolve(a.data)},b.reject)})}}}]);var mobileSdkDataApp=angular.module("ag.mobile-sdk.data",["ag.sdk.utilities","ag.sdk.config","ag.sdk.monitor","ag.sdk.library","ag.mobile-sdk.cordova.storage"]);mobileSdkDataApp.provider("dataPurge",function(){this.$get=["promiseService","dataStore",function(a,b){return function(c){return a.wrapAll(function(a){angular.forEach(c,function(c){a.push(b(c).transaction().then(function(a){return a.purgeItems()}))})})}}]}),mobileSdkDataApp.constant("dataStoreConstants",{NoStoreParams:{code:"NoStoreParams",message:"No DataStore parameters defined"},NoConfigDBNameParams:{code:"NoConfigDBNameParams",message:"No Config database name defined"},NoConfigAPIParams:{code:"NoConfigAPIParams",message:"No Config API parameters defined"},NoConfigPagingParams:{code:"NoConfigPagingParams",message:"No Config Paging parameters defined"},NoReadParams:{code:"NoReadParams",message:"No DataRead parameters defined"},NoPagingDefined:{code:"NoPagingDefined",message:"No Paging parameters have been defined in config"},LocalDataStoreError:{code:"LocalDataStoreError",message:"Can not perform action on local data store"},RemoteDataStoreError:{code:"RemoteDataStoreError",message:"Can not perform action on remote data store"},RemoteNoDataError:{code:"RemoteNoDataError",message:"No data response from remote store"}}),mobileSdkDataApp.factory("dataStoreUtilities",["$log","$timeout","dataStoreConstants","promiseService","underscore",function(a,b,c,d,e){function f(b){a.warn("string"==typeof b?"Error: "+b:void 0!==b.message?"Error: "+b.message+"("+b.code+")":b)}return{parseRequest:function(a,b){return void 0!==a&&angular.forEach(b,function(b,c){a=a.replace("/:"+c,void 0!==b?"/"+b:"")}),a},generateItemIndex:function(){return 2e9+Math.round(147483647*Math.random())},injectMetadata:function(a){return e.extend("object"==typeof a.data?a.data:JSON.parse(a.data),{__id:a.id,__uri:a.uri,__complete:1==a.complete,__dirty:1==a.dirty,__local:1==a.local,__saved:!0})},extractMetadata:function(a){return{id:a.__id,uri:a.__uri,complete:a.__complete,dirty:a.__dirty,local:a.__local,data:e.omit(a,["__id","__uri","__complete","__dirty","__local","__saved"])}},transactionPromise:function(e){var f=0,g=function(c){f++,e.transaction(function(a){c.resolve(a)},function(d){10>=f?(a.warn("Waiting for transaction"),a.warn(JSON.stringify(d)),b(function(){g(c)},250)):c.reject(d)})};return d.wrap(function(a){e?g(a):a.reject(c.LocalDataStoreError)})},executeSqlPromise:function(a,b,e){return e=e||[],d.wrap(function(d){a?a.executeSql(b,e,function(a,b){d.resolve(b)},function(a,b){f(b),d.reject(b)}):d.reject(c.LocalDataStoreError)})}}}]),mobileSdkDataApp.provider("dataStore",["dataStoreConstants","underscore",function(a,b){var c,d={pageLimit:10,dbName:void 0,readLocal:!0,readRemote:!0};this.config=function(a){d=b.defaults(a||{},d)},this.$get=["$http","$log","$rootScope","fileStorageService","localStore","promiseService","safeApply","configuration","dataStoreUtilities",function(e,f,g,h,i,j,k,l,m){function n(a){f.error("_errorCallback"),f.error(a),f.error(JSON.stringify(a))}function o(){function a(c){f.debug("_processMigration");var d=i.getItem("dataStore-dbVersion","");if(f.debug("Current version: "+d),b.length>0){var e=b[0];b.splice(0,1),e.current===d?(f.debug("Database ("+d+") has a newer version "+e.next),m.transactionPromise(c).then(e.process).then(function(){f.debug("Database version migrated from "+e.current+" to "+e.next),i.setItem("dataStore-dbVersion",e.next),a(c)})):a(c)}}var b=[{current:"",next:"1",process:function(a){return m.executeSqlPromise(a,"SELECT name FROM sqlite_master WHERE type = ? ",["table"]).then(function(b){return j.wrapAll(function(c){for(var d=0;d<b.rows.length;d++){var e=b.rows.item(d);-1===e.name.indexOf("__")&&c.push(m.executeSqlPromise(a,"ALTER TABLE "+e.name+" ADD COLUMN complete INT DEFAULT 1"))}})})}}];c=window.openDatabase(d.dbName,"",d.dbName,4194304),a(c)}function p(g,i){function k(){return m.transactionPromise(c).then(function(a){return j.all([m.executeSqlPromise(a,"CREATE TABLE IF NOT EXISTS "+g+" (id INT UNIQUE, uri TEXT, complete INT DEFAULT 0, dirty INT DEFAULT 0, local INT DEFAULT 0, data TEXT, updated TIMESTAMP DEFAULT current_timestamp)",[]),m.executeSqlPromise(a,"CREATE TRIGGER IF NOT EXISTS "+g+"_timestamp AFTER UPDATE ON "+g+" BEGIN UPDATE "+g+"  SET updated = datetime('now') WHERE id = old.id AND uri = old.uri; END",[])])},j.throwError)}function l(){return m.transactionPromise(c).then(function(a){return m.executeSqlPromise(a,"DELETE FROM "+g,[])},j.throwError)}function o(a,b){return void 0===a[t.indexerProperty]&&f.warn("Configured indexer property not defined"),a[t.indexerProperty]||a.id||b}function s(){return this instanceof s?{createItems:function(a){var c=b.defaults(a||{},{template:t.apiTemplate,schema:{},data:[],options:{}});return c.options=b.defaults(c.options,{replace:!0,force:!1,complete:!0,dirty:!0}),j.wrapAll(function(a){c.data instanceof Array==!1&&(c.data=[c.data]),angular.forEach(c.data,function(d){var e=o(d,m.generateItemIndex());a.push(t.dehydrate(m.injectMetadata({id:e,uri:m.parseRequest(c.template,b.defaults(c.schema,{id:e})),data:d,complete:c.options.complete,dirty:c.options.dirty,local:c.options.dirty}),c.options))})},j.throwError).then(function(a){return x(b.compact(a),c)},j.throwError).then(function(a){return G(a,!0)},j.throwError)},getItems:function(c){var d=b.defaults(c||{},{template:t.apiTemplate,schema:{},options:{}});return d.options=b.defaults(d.options,{fallbackRemote:!1,one:void 0!==d.options.one?d.options.one:void 0!==d.schema.id,passThrough:!1,readLocal:t.readLocal,readRemote:t.readRemote,remoteHydration:!0}),j.wrap(function(c){var e=function(a){A(a,d).then(function(e){d.options.passThrough===!0?c.resolve(G(b.map(e,function(a){var c=o(a,m.generateItemIndex());return m.injectMetadata({id:c,uri:m.parseRequest(d.template,b.defaults(d.schema,{id:c})),data:a,complete:d.options.one||void 0===d.params||"simple"!==d.params.resulttype,dirty:!1,local:!1})}),d.options.one)):void 0===d.params&&d.options.readLocal===!0?w(e,a,d).then(function(a){c.resolve(G(a,d.options.one))},c.reject):x(e,d).then(function(a){c.resolve(G(a,d.options.one))},c.reject)},function(b){d.options.readLocal===!0?u(a,d).then(function(a){c.resolve(G(a,d.options.one))},c.reject):(n(b),c.reject(b))})};if("object"==typeof d.schema){var f=m.parseRequest(d.template,d.schema);d.options.readRemote===!0?e(f):u(f,d).then(function(a){0==a.length&&d.options.fallbackRemote===!0&&void 0===d.options.filter?e(f):H(a,d,d.options.one).then(c.resolve,c.reject)},function(a){n(a),c.reject(a)})}else c.reject(a.NoReadParams)})},findItems:function(a){var c=b.defaults(a||{},{key:"",column:"id",options:{}});return c.options=b.defaults(c.options,{fallbackRemote:!0,like:!1,one:!1,remoteHydration:!0}),v(c.key,c.column,c.options).then(function(a){return H(a,c,!0)},j.throwError)},updateItems:function(a){var c=b.defaults(a||{},{data:[],options:{}});return c.options=b.defaults(c.options,{dirty:!0}),c.data instanceof Array==!1&&(c.data=[c.data]),x(c.data,c).then(function(a){return G(a,!0)},j.throwError)},postItems:function(a){var c=b.defaults(a||{},{template:t.apiTemplate,schema:{},data:[],options:{}});return c.data instanceof Array==!1&&(c.data=[c.data]),B(c.data,c).then(function(a){return G(a,!0)},j.throwError)},removeItems:function(a){var c=b.defaults(a||{},{template:void 0,schema:{},data:[]});return c.data instanceof Array==!1&&(c.data=[c.data]),j.wrapAll(function(a){angular.forEach(c.data,function(b){a.push(b.__local===!0?y(b):C(b,c.template,c.schema))})}).then(function(a){return G(a,!0)},j.throwError)},purgeItems:function(a){var c=b.defaults(a||{},{template:void 0,schema:{},options:{},callback:angular.noop});return c.options=b.defaults(c.options,{force:!0}),j.wrap(function(a){if(void 0!==c.template){var d=m.parseRequest(c.template,c.schema);u(d,c).then(function(a){var d=b.filter(a,function(a){return 0==a.__dirty||1==c.options.force});return y(d)},j.throwError).then(a.resolve,a.reject)}else l().then(a.resolve,a.reject)})}}:new s}if(!(this instanceof p))return new p(g,i);if("string"!=typeof g)throw new Error(a.NoStoreParams.msg);if(void 0===d.dbName)throw new Error(a.NoConfigDBNameParams.msg);g=g.replace("-","");var t=b.defaults(i||{},{apiTemplate:void 0,paging:void 0,indexerProperty:"id",readLocal:d.readLocal,readRemote:d.readRemote,hydrate:r,dehydrate:r});void 0!==t.paging&&(t.paging=b.defaults(t.paging,{template:"",schema:{},data:{page:1,limit:d.pageLimit}}));var u=function(a,b){return f.debug("_getLocal"),b.options=b.options||{},m.transactionPromise(c).then(function(b){return m.executeSqlPromise(b,"SELECT * FROM "+g+" WHERE uri = ?",[a])},j.throwError).then(function(a){return j.wrapAll(function(c){for(var d="function"==typeof b.options.filter,e=0;e<a.rows.length;e++){var f=m.injectMetadata(a.rows.item(e));(!d||b.options.filter(f))&&c.push(t.hydrate(f,b.options))}})},j.throwError)},v=function(a,b,d){return f.debug("_findLocal"),m.transactionPromise(c).then(function(c){return m.executeSqlPromise(c,"SELECT * FROM "+g+" WHERE "+b+" "+(d.like?"LIKE":"=")+" ?",[d.like?"%"+a+"%":a])},j.throwError).then(function(a){return j.wrapAll(function(b){for(var c=0;c<a.rows.length;c++)b.push(t.hydrate(m.injectMetadata(a.rows.item(c)),d))})},j.throwError)},w=function(a,b,c){return f.debug("_syncLocal"),z(b).then(function(){return x(a,{})},j.throwError).then(function(){return u(b,c)},j.throwError)},x=function(a,d){return f.debug("_updateLocal"),a instanceof Array==!1&&(a=[a]),d.options=b.defaults(d.options||{},{replace:!0,force:!1}),j.wrapAll(function(b){angular.forEach(a,function(a){b.push(t.dehydrate(a,d.options))})}).then(function(a){return m.transactionPromise(c).then(function(b){return j.wrapAll(function(c){angular.forEach(a,function(a){var e=m.extractMetadata(a),f=JSON.stringify(e.data),h=function(){return a};e.dirty=d.options.dirty===!0?!0:e.dirty,c.push(m.executeSqlPromise(b,"INSERT INTO "+g+" (id, uri, data, complete, dirty, local) VALUES (?, ?, ?, ?, ?, ?)",[e.id,e.uri,f,e.complete?1:0,e.dirty?1:0,e.local?1:0]).then(h,function(){return d.options.replace===!0?e.dirty===!0||e.local===!0||d.options.force?m.executeSqlPromise(b,"UPDATE "+g+" SET uri = ?, data = ?, complete = ?, dirty = ?, local = ? WHERE id = ?",[e.uri,f,e.complete?1:0,e.dirty?1:0,e.local?1:0,e.id]).then(h):m.executeSqlPromise(b,"UPDATE "+g+" SET uri = ?, data = ?, complete = ?, dirty = ?, local = ? WHERE id = ? AND dirty = 0 AND local = 0",[e.uri,f,e.complete?1:0,e.dirty?1:0,e.local?1:0,e.id]).then(h):null}))})})})},j.throwError).then(function(a){return j.wrapAll(function(c){angular.forEach(b.compact(a),function(a){c.push(t.hydrate(a,d.options))})})},j.throwError)},y=function(a){return f.debug("_deleteLocal"),a instanceof Array==!1&&(a=[a]),m.transactionPromise(c).then(function(b){return j.wrapAll(function(c){angular.forEach(a,function(a){var d=m.extractMetadata(a);c.push(m.executeSqlPromise(b,"DELETE FROM "+g+" WHERE id = ? AND uri = ?",[d.id,d.uri]))})})},j.throwError).then(function(){return a},j.throwError)},z=function(a,d){return f.debug("_deleteAllLocal"),d=b.defaults(d||{},{force:!1}),m.transactionPromise(c).then(function(b){return d.force===!0?(f.debug("_deleteAllLocal force"),m.executeSqlPromise(b,"DELETE FROM "+g+" WHERE uri = ?",[a])):(f.debug("_deleteAllLocal not force"),m.executeSqlPromise(b,"DELETE FROM "+g+" WHERE uri = ? AND local = ? AND dirty = ?",[a,0,0]))})},A=function(c,d){return f.debug("_getRemote"),d.options=d.options||{},j.wrap(function(f){void 0!==t.apiTemplate?e.get(q+c,{params:d.params,withCredentials:!0}).then(function(a){return a&&a.data?a.data instanceof Array?a.data:[a.data]:[]},j.throwError).then(function(a){return j.wrapAll(function(e){angular.forEach(a,function(a){e.push(t.dehydrate(m.injectMetadata({id:o(a),uri:d.options.forceUri||c,data:a,complete:d.options.one||void 0===d.params||"simple"!==d.params.resulttype,dirty:!1,local:!1}),b.defaults(d.options,{dehydrate:!0})))})})},j.throwError).then(f.resolve,f.reject):f.reject(a.RemoteDataStoreError)})},B=function(c,d){return f.debug("_updateRemote"),d.options=d.options||{},j.wrap(function(f){void 0!==c&&void 0!==t.apiTemplate?(c instanceof Array==!1&&(c=[c]),j.wrapAll(function(a){angular.forEach(c,function(c){var f=m.extractMetadata(c),g=f.data,i=f.uri;if(f.dirty===!0||d.options.force){(f.local||void 0!==d.template)&&(f.local&&void 0!==f.data[t.indexerProperty]&&delete f.data[t.indexerProperty],i=m.parseRequest(d.template||t.apiTemplate,b.extend(d.schema,{id:f.local?void 0:f.id})));var k=g.data&&g.data.attachments?angular.copy(g.data.attachments):void 0,l=k?b.where(k,{local:!0}):[];k&&l.length>0&&(g.data.attachments=b.difference(k,l)),a.push(e.post(q+i,g,{withCredentials:!0}).then(function(a){var b=m.injectMetadata({id:o(a.data,f.id),uri:f.uri,data:a.data,complete:!0,dirty:!1,local:!1});return 1==f.local?(b.id=b.__id,y(c).then(function(){return b})):b},j.throwError).then(function(a){return l.length>0?(i=m.parseRequest((d.template||t.apiTemplate)+"/attach",b.extend(d.schema,{id:a.id})),j.chain(function(a){angular.forEach(l,function(c){a.push(function(){return h.read(c.src,!0).then(function(a){return e.post(q+i,{archive:b.extend(b.omit(c,["src","local","key","sizes"]),{filename:a.file,content:a.content.substring(a.content.indexOf(",")+1)})},{withCredentials:!0}).then(function(a){return a&&a.data?b.last(a.data):void 0},j.throwError)},j.throwError)})})}).then(function(c){return a.data.attachments=b.chain(a.data.attachments).union(c).compact().value(),a},j.throwError)):a},j.throwError))}})},j.throwError).then(function(a){return d.options=b.defaults({force:!0},d.options),x(b.compact(a),d)},j.throwError).then(f.resolve,f.reject)):f.reject(a.RemoteDataStoreError)})},C=function(c,d,g){return f.debug("_deleteRemote"),j.wrap(function(f){void 0!==c&&void 0!==d?(c instanceof Array==!1&&(c=[c]),j.wrapAll(function(a){angular.forEach(c,function(c){if(c.local===!1){var f=m.extractMetadata(c),h=m.parseRequest(d,b.defaults(g,{id:f.id}));a.push(e.post(q+h,{withCredentials:!0}).then(function(){return y(f)},j.throwError))}})}).then(f.resolve,f.reject)):f.reject(a.RemoteDataStoreError)})},D=!1,E=[],F=function(){if(D&&void 0!==c)for(;E.length>0;){var a=E.shift();a.resolve(new s)}},G=function(a,b){return b===!0&&a instanceof Array&&a.length>0?a[0]:a},H=function(a,c,d){return c.options.one=!0,c.schema=c.schema||{},j.chain(function(d){angular.forEach(a,function(a){d.push(function(){if(a.__complete!==!1||c.options.fallbackRemote!==!0||void 0!==c.options.hydrateRemote&&c.options.hydrateRemote!==!0)return a;var d=m.parseRequest(t.apiTemplate,b.defaults({id:a.__id},c.schema));return c.options.force=!0,c.options.forceUri=a.__uri,A(d,c).then(function(a){return x(a,c)})})})}).then(function(a){return G(a,d)})};return k().then(function(){f.debug("table initialized"),D=!0,F()}),{defaults:d,config:t,transaction:function(){var a=j.defer();return E.push(a),F(),a.promise}}}var q=l.getServer()+"api/",r=function(a){return j.wrap(function(b){b.resolve(a)})};return o(),function(a,b){return new p(a,b)}}]}]);var mobileSdkHydrationApp=angular.module("ag.mobile-sdk.hydration",["ag.sdk.utilities","ag.sdk.library"]);mobileSdkHydrationApp.provider("hydration",[function(){var a={};this.registerHydrate=function(b,c){a[b]=a[b]||{},a[b].hydrate=c},this.registerDehydrate=function(b,c){a[b]=a[b]||{},a[b].dehydrate=c},this.$get=["$injector","promiseService","underscore",function(b,c,d){return{hydrate:function(e,f,g){return c.objectWrap(function(c){g.hydrate&&g.hydrate instanceof Array&&angular.forEach(g.hydrate,function(d){var h=a[d];h&&h.hydrate&&(h.hydrate instanceof Array&&(a[d].hydrate=b.invoke(h.hydrate)),c[d]=h.hydrate(e,f,g))})}).then(function(a){return a?d.extend(e,a):e},function(){return e})},dehydrate:function(e,f,g){return c.objectWrap(function(c){g.dehydrate&&g.dehydrate instanceof Array&&angular.forEach(g.dehydrate,function(d){var g=a[d];e[d]&&g&&g.dehydrate&&(g.dehydrate instanceof Array&&(a[d].dehydrate=b.invoke(g.dehydrate)),c[d]=g.dehydrate(e,f))})}).then(function(){return d.omit(e,g.dehydrate)},function(){return d.omit(e,g.dehydrate)})}}}]}]),angular.module("ag.sdk.helper",["ag.sdk.helper.asset","ag.sdk.helper.attachment","ag.sdk.helper.crop-inspection","ag.sdk.helper.document","ag.sdk.helper.enterprise-budget","ag.sdk.helper.expense","ag.sdk.helper.farmer","ag.sdk.helper.favourites","ag.sdk.helper.merchant","ag.sdk.helper.production-plan","ag.sdk.helper.region","ag.sdk.helper.task","ag.sdk.helper.team","ag.sdk.helper.user"]),angular.module("ag.sdk.interface",["ag.sdk.interface.ui","ag.sdk.interface.list","ag.sdk.interface.map","ag.sdk.interface.navigation"]),angular.module("ag.sdk.test",["ag.sdk.test.data"]),angular.module("ag.mobile-sdk",["ag.sdk.authorization","ag.sdk.id","ag.sdk.utilities","ag.sdk.monitor","ag.sdk.interface.map","ag.sdk.helper","ag.sdk.library","ag.sdk.test","ag.mobile-sdk.helper","ag.mobile-sdk.api","ag.mobile-sdk.data","ag.mobile-sdk.hydration"]);
>>>>>>> develop
