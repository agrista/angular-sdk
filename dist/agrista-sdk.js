...
//            console.log(budget.data);
                    ...
                    if(budget.assetType != 'horticulture' || (budget.assetType == 'horticulture' && section.horticultureStage == horticultureStage)) {
                        section.productCategoryGroups.forEach(function(group, j) {
                            group.productCategories.forEach(function(category, k) {
                                categories[group.name].forEach(function(option, l) {
        ...
        calculateTotals: function (budget) {
            ...
            budget.data.sections.forEach(function(section, i) {
                ...
                section.productCategoryGroups.forEach(function(group, j) {
                    ...
                    group.productCategories.forEach(function(category, k) {
                        if(category.unit == '%') {
                            var groupSum = 0;
                            budget.data.sections.forEach(function(cSection, x) {
                                cSection.productCategoryGroups.forEach(function(cGroup, y) {
            ...
            if(budget.assetType == 'horticulture') {
                ...
                _horticultureStages[budget.commodityType].forEach(function(stage, i) {
                    var stageIncome = 0;
                    var stageCosts = 0;
                    budget.data.sections.forEach(function(section, j) {
