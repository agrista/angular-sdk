...
return{restrict:"E",require:"^mapbox",replace:!0,transclude:!0,template:'<div class="leaflet-control"><div class="leaflet-bar" ng-transclude></div></div>',link:function(a,b,d){c=void 0==d.position?"bottomright":d.position},controller:function(a){b(a)}}}]);var sdkInterfaceNavigiationApp=angular.module("ag.sdk.interface.navigation",["ag.sdk.authorization","ag.sdk.library"]);sdkInterfaceNavigiationApp.provider("navigationService",["underscore",function(a){var b={},c=[],d={Favourites:1,Assets:2,Apps:3,Administration:4},e={left:[],right:[]},f=function(a,b){return a.order-b.order},g=this.registerApps=function(c){c=c instanceof Array?c:[c],angular.forEach(c,function(c){c=a.defaults(c,{id:c.title,order:100,group:"Apps",include:function(a,b){return-1!==b.indexOf(a.id)}}),c.title&&c.state&&(b[c.title]=c)})};this.$get=["$rootScope","$state","authorization",function(h,i,j){var k=!1,l="",m=function(b){var e=a.findWhere(c,{title:b.group});void 0===e&&(e={title:b.group,order:d[b.group]||100,items:[]},c.push(e),c=c.sort(f));var g=a.findWhere(e.items,{id:b.id});void 0===g&&(b.active=i.includes(b.state),e.items.push(b),e.items=e.items.sort(f),h.$broadcast("navigation::items__changed",c),h.$broadcast("navigation::app__allowed",b))},n=function(){c=[],h.$broadcast("navigation::items__changed",c)},o=function(c){var d=c||j.currentUser(),e=d.userRole?a.pluck(d.userRole.apps,"name"):[],f=d.organization?a.pluck(d.organization.services,"serviceType"):[];n(),angular.forEach(b,function(a){("function"==typeof a.include&&a.include(a,e,f)||a.include===!0)&&m(a)})},p=function(a,b){b&&(b instanceof Array==!1?e[a].push(b):e[a]=b,h.$broadcast("navigation::"+a+"-buttons__changed",e[a]),h.$broadcast("navigation::buttons__changed"))};return h.$on("$stateChangeSuccess",function(){angular.forEach(c,function(a){angular.forEach(a.items,function(a){a.active=i.includes(a.state)})})}),h.$on("authorization::login",function(a,b){o(b)}),h.$on("authorization::unauthorized",function(){n()}),h.$on("authorization::logout",function(){n()}),o(),{getGroupedApps:function(){return c},renameApp:function(d,e){var f=a.findWhere(b,{id:d});f&&(f.title=e,h.$broadcast("navigation::items__changed",c))},selectItem:function(a){return h.$broadcast("navigation::item__selected",a),i.go(a)},registerApps:function(a){g(a)},unregisterApps:function(){b={},c=[]},allowApp:function(a){b[a]&&m(b[a])},toggleSlim:function(){k=!k,h.$broadcast("navigation::slim__changed",k)},isSlim:function(){return k},footerText:function(a){return void 0!==a&&(l=a,h.$broadcast("navigation::footerText",l)),l},leftButtons:function(a){return p("left",a),e.left},rightButtons:function(a){return p("right",a),e.right}}}]}]);var sdkInterfaceUiApp=angular.module("ag.sdk.interface.ui",[]);sdkInterfaceUiApp.directive("dynamicName",function(){return{restrict:"A",require:"?form",link:function(a,b,c,d){var e=null!=d?d:b.parent().controller("form"),f=e[b.attr("name")];b.attr("name",c.name),e.$removeControl(f),f.$name=c.name,e.$addControl(f)}}}),sdkInterfaceUiApp.directive("defaultSrc",[function(){return{restrict:"A",link:function(a,b,c){b.bind("error",function(){b.attr("src",c.defaultSrc)})}}}]),sdkInterfaceUiApp.filter("location",["$filter",function(a){return function(b){return(b&&b.geometry?a("number")(b.geometry.coordinates[0],3)+", "+a("number")(b.geometry.coordinates[1],3):"")+(b&&b.properties&&b.properties.accuracy?" at "+a("number")(b.properties.accuracy,2)+"m":"")}}]),sdkInterfaceUiApp.directive("locationFormatter",["$filter",function(a){return{restrict:"A",require:"ngModel",link:function(b,c,d,e){e.$formatters.push(function(c){var e="";return void 0!==c&&(e=a("location")(c),d.ngChange&&b.$eval(d.ngChange)),e})}}}]),sdkInterfaceUiApp.directive("dateFormatter",["$filter",function(a){return{restrict:"A",require:"ngModel",link:function(b,c,d,e){e.$formatters.push(function(b){return void 0!==b?a("date")(new Date(b),d.dateFormat||"yyyy-MM-dd"):""})}}}]),sdkInterfaceUiApp.directive("dateParser",["$filter",function(a){return{restrict:"A",require:"ngModel",link:function(b,c,d,e){e.$parsers.push(function(b){return void 0!==b?a("date")(new Date(b),d.dateFormat||"yyyy-MM-dd"):""})}}}]),sdkInterfaceUiApp.directive("inputNumber",["$filter",function(a){return{restrict:"A",require:"ngModel",link:function(b,c,d,e){var f=d.max?parseFloat(d.max):!1,g=d.min?parseFloat(d.min):!1,h=d.round?parseInt(d.round):!1;e.$formatters.push(function(b){return h===!1?b:a("number")(b,h)}),e.$parsers.push(function(a){var b=isNaN(a)||isNaN(parseFloat(a));if(e.$setValidity("number",b===!1),b===!1){var c=parseFloat(a);return e.$setValidity("range",(g===!1||c>=g)&&(f===!1||f>=c)),c}return void 0})}}}]);var sdkModelAsset=angular.module("ag.sdk.model.asset",["ag.sdk.library","ag.sdk.model.base","ag.sdk.model.liability","ag.sdk.model.production-schedule"]);sdkModelAsset.factory("Asset",["$filter","computedProperty","inheritModel","Liability","Model","privateProperty","ProductionSchedule","readOnlyProperty","underscore",function(a,b,c,d,e,f,g,h,i){function j(c){e.Base.apply(this,arguments),i.isUndefined(c)||0===arguments.length||(this.id=c.id||c.$id,this.assetKey=c.assetKey,this.farmId=c.farmId,this.legalEntityId=c.legalEntityId,this.liabilities=i.map(c.liabilities,function(a){return d.new(a)}),this.productionSchedules=i.map(c.productionSchedules,function(a){return g.new(a)}),this.type=c.type,this.data=c.data||{},f(this,"generateKey",function(a,b){this.assetKey=(a?"entity."+a.uuid:"")+("farmland"!==this.type&&b?"-f."+b.name:"")+("crop"===this.type&&this.data.season?"-s."+this.data.season:"")+(this.data.fieldName?"-fi."+this.data.fieldName:"")+(this.data.crop?"-c."+this.data.crop:"")+("cropland"===this.type&&this.data.irrigated?"-i."+this.data.irrigation:"")+("farmland"===this.type&&this.data.sgKey?"-"+this.data.sgKey:"")+("improvement"===this.type||"livestock"===this.type||"vme"===this.type?(this.data.type?"-t."+this.data.type:"")+(this.data.category?"-c."+this.data.category:"")+(this.data.name?"-n."+this.data.name:"")+(this.data.purpose?"-p."+this.data.purpose:"")+(this.data.model?"-m."+this.data.model:"")+(this.data.identificationNo?"-in."+this.data.identificationNo:""):"")+(this.data.waterSource?"-ws."+this.data.waterSource:"")+("other"===this.type&&this.data.name?"-n."+this.data.name:"")}),b(this,"title",function(){switch(this.type){case"crop":case"permanent crop":case"plantation":return(this.data.plantedArea?a("number")(this.data.plantedArea,2)+"Ha":"")+(this.data.plantedArea&&this.data.crop?" of ":"")+(this.data.crop?this.data.crop:"")+(this.data.fieldName?" on field "+this.data.fieldName:"");case"farmland":return this.data.portionLabel?this.data.portionLabel:this.data.portionNumber?"Portion "+this.data.portionNumber:"Remainder of farm";case"cropland":return(this.data.equipped?"Irrigated "+this.type+" ("+(this.data.irrigation?this.data.irrigation+" irrigation from ":"")+this.data.waterSource+")":(this.data.irrigated?"Irrigable, unequipped ":"Non irrigable ")+this.type)+(this.data.fieldName?" on field "+this.data.fieldName:"");case"livestock":return this.data.type+(this.data.category?" - "+this.data.category:"");case"pasture":return(this.data.intensified?this.data.crop||"Intensified pasture":"Natural grazing")+(this.data.fieldName?" on field "+this.data.fieldName:"");case"vme":return this.data.category+(this.data.model?" model "+this.data.model:"");case"wasteland":return"Wasteland";case"water source":case"water right":return this.data.waterSource+(this.data.fieldName?" on field "+this.data.fieldName:"");default:return this.data.name||this.assetTypes[this.type]}}),b(this,"liquidityTypeTitle",function(){return this.data.liquidityType&&this.assetTypes[this.data.liquidityType]||""}),b(this,"description",function(){return this.data.description||""}),f(this,"incomeInRange",function(a,b){var c={};return this.data.sold===!0&&this.data.salePrice&&moment(this.data.soldDate).isBetween(a,b)&&(c.Sales=this.data.salePrice),c}),f(this,"totalIncomeInRange",function(a,b){return i.reduce(this.incomeInRange(a,b),function(a,b){return a+(b||0)},0)}),f(this,"totalLiabilityInRange",function(a,b){return i.reduce(this.liabilities,function(c,d){return c+d.totalLiabilityInRange(a,b)},0)}))}return c(j,e.Base),h(j,"assetTypes",{crop:"Crops",farmland:"Farmlands",improvement:"Fixed Improvements",cropland:"Cropland",livestock:"Livestock",pasture:"Pastures","permanent crop":"Permanent Crops",plantation:"Plantations",vme:"Vehicles, Machinery & Equipment",wasteland:"Wasteland","water right":"Water Rights"}),h(j,"liquidityTypes",{"long-term":"Long-term","medium-term":"Movable","short-term":"Current"}),h(j,"assetTypesWithOther",i.extend({other:"Other"},j.assetTypes)),j.validates({farmId:{numeric:!0},legalEntityId:{required:!0,numeric:!0},assetKey:{required:!0},type:{required:!0,inclusion:{"in":i.keys(j.assetTypesWithOther)}}}),j}]),angular.module("ag.sdk.model.base",["ag.sdk.library","ag.sdk.model.validation","ag.sdk.model.errors","ag.sdk.model.store"]).factory("Model",["Base",function(a){var b={};return b.Base=a,b}]).factory("Base",["Errorable","Storable","underscore","Validatable",function(a,b,c,d){function e(){{var e=this;e.prototype}e.new=function(a){var b=new e(a);return"function"==typeof b.storable&&b.storable(a),b},e.asJSON=function(){return JSON.parse(JSON.stringify(this))},e.copy=function(){var a=this,b={},d=Object.getOwnPropertyNames(a);return c.each(d,function(c){Object.defineProperty(b,c,Object.getOwnPropertyDescriptor(a,c))}),b},e.extend=function(a){var b=new a,d=Object.getOwnPropertyNames(b),e=c.filter(d,function(a){return"__"!==a.slice(0,2)});c.each(e,function(a){Object.defineProperty(this,a,Object.getOwnPropertyDescriptor(b,a))},this)},e.include=function(a){var b=new a,d=Object.getOwnPropertyNames(b),e=c.filter(d,function(a){return"__"==a.slice(0,2)}),f=this.new;this.new=function(){var a=f.apply(this,arguments);return c.each(e,function(c){Object.defineProperty(a,c.slice(2),Object.getOwnPropertyDescriptor(b,c))}),a}},e.extend(d),e.extend(b),e.include(d),e.include(a),e.include(b)}return e}]).factory("computedProperty",[function(){return function(a,b,c){Object.defineProperty(a,b,{get:c})}}]).factory("readOnlyProperty",[function(){return function(a,b,c){Object.defineProperty(a,b,{writable:!1,value:c})}}]).factory("inheritModel",["underscore",function(a){return function(b,c){c.apply(b),a.each(Object.getOwnPropertyNames(c),function(d){var e=Object.getOwnPropertyDescriptor(c,d);a.isUndefined(b[d])&&e&&Object.defineProperty(b,d,e)})}}]).factory("privateProperty",[function(){return function(a,b,c){var d;Object.defineProperty(a,b,{enumerable:!1,configurable:!1,get:function(){return d},set:function(a){d=a}}),void 0!==c&&(a[b]=c)}}]);var sdkModelBusinessPlanDocument=angular.module("ag.sdk.model.business-plan",["ag.sdk.id","ag.sdk.helper.enterprise-budget","ag.sdk.model.asset","ag.sdk.model.document","ag.sdk.model.legal-entity","ag.sdk.model.liability","ag.sdk.model.farm-valuation","ag.sdk.model.production-schedule"]);sdkModelBusinessPlanDocument.factory("BusinessPlan",["Asset","computedProperty","Document","enterpriseBudgetHelper","FarmValuation","generateUUID","inheritModel","LegalEntity","Liability","privateProperty","ProductionSchedule","underscore",function(a,b,c,d,e,f,g,h,i,j,k,l){function m(){function d(a){r(a),y(a),x(a),D(a),f(a)}function f(a){J(a),K(a),L(a)}function g(a){return l.range(a).map(function(){return 0})}function m(a){return isFinite(a)?a:0}function n(a,b){return l.chain(a).pluck(b).reduce(function(a,b){return a+b},0).value()}function o(a,b){return a.length!=b.length?[]:l.reduce(b,function(a,b,c){return a[c]=m(a[c]/b),a},a)}function p(a,b){return a&&b&&a.length==b.length?l.reduce(a,function(a,b,c){return a[c]+=b,a},b):[]}function q(a){return l.map(a,function(a){return-1*a})}function r(b){b.data.monthlyStatement=l.reject(b.data.monthlyStatement,function(a){return"legal entity"===a.source}),l.each(b.models.legalEntities,function(c){var d=h.new(c),e=l.chain(b.data.assets).values().flatten().where({legalEntityId:d.id}).value(),f=l.chain(b.data.liabilities).where({legalEntityId:d.id}).value();l.each(e,function(c){var e=l.findWhere(b.data.monthlyStatement,{uuid:c.assetKey});l.isUndefined(e)&&(c=a.new(c),b.data.monthlyStatement.push({uuid:c.assetKey,legalEntityUuid:d.uuid,name:c.title,description:"improvement"===c.type?c.data.category:c.description,type:"asset",subtype:c.type,source:"legal entity",value:c.data.assetValue||0}))}),l.each(f,function(a){var c=l.findWhere(b.data.monthlyStatement,{uuid:a.uuid});l.isUndefined(c)&&(a=i.new(a),b.data.monthlyStatement.push({uuid:a.uuid,legalEntityUuid:d.uuid,name:i.getTypeTitle(a.type),type:"liability",subtype:a.type,source:"legal entity",liability:a.liabilityInRange(b.startDate,b.endDate)}))})})}function s(a,b,c,d){a.data[b]=a.data[b]||{},a.data[b][c]=a.data[b][c]||l.range(d).map(function(){return 0})}function t(a,b){return a?Math.min(a.length,Math.abs(Math.min(0,b))):0}function u(a,b,c){return a?Math.min(c,b+a.length)-b:0}function v(a,b,c,d,e,f){var g=l.findWhere(b.data.sections,{code:c}),h=moment(b.startDate).add(1,"days");if(g){var i=h.diff(e,"months");angular.forEach(g.productCategoryGroups,function(c){angular.forEach(c.productCategories,function(c){var e="livestock"!==b.type&&"productionIncome"===d?b.data.details.commodity:c.name;a.data[d][e]=a.data[d][e]||l.range(f).map(function(){return 0});for(var g=t(c.valuePerMonth,i),h=u(c.valuePerMonth,i,f),j=g;h>j;j++)a.data[d][e][j+i]+=c.valuePerMonth[j]||0})})}}function w(a,b,c,d){var e=l.findWhere(b.data.sections,{code:"INC"}),f=moment(b.startDate).add(1,"days");if(e){for(var g=Math.ceil(d/12);a.data.productionIncomeComposition.length<g;)a.data.productionIncomeComposition.push({});for(var h=0;g>h;h++){var i=Math.min(12,d-12*h),j=f.diff(moment(c).add(h,"years"),"months");angular.forEach(e.productCategoryGroups,function(c){angular.forEach(c.productCategories,function(c){for(var d="livestock"!==b.type?b.data.details.commodity:c.name,e=a.data.productionIncomeComposition[h][d]||{unit:c.unit,pricePerUnit:0,quantity:0,value:0},f=t(c.valuePerMonth,j),g=u(c.valuePerMonth,j,i),k=f;g>k;k++)e.value+=c.valuePerMonth[k];for(f=t(c.quantityPerMonth,j),g=u(c.quantityPerMonth,j,i),k=f;g>k;k++)e.quantity+=c.quantityPerMonth[k];e.pricePerUnit=!e.pricePerUnit&&c.pricePerUnit?c.pricePerUnit:m(e.value/e.quantity),a.data.productionIncomeComposition[h][d]=e})});var k=l.chain(a.data.productionIncomeComposition[h]).values().pluck("value").reduce(function(a,b){return a+b},0).value();for(var n in a.data.productionIncomeComposition[h])a.data.productionIncomeComposition[h].hasOwnProperty(n)&&"total"!=n&&(a.data.productionIncomeComposition[h][n].contributionPercent=100*m(a.data.productionIncomeComposition[h][n].value/k));a.data.productionIncomeComposition[h].total={value:k}}}}function x(a){var b=moment(a.startDate),c=moment(a.endDate),d=c.diff(b,"months");a.data.productionIncome={},a.data.productionExpenditure={},a.data.productionIncomeComposition=[],angular.forEach(a.models.productionSchedules,function(c){var e=k.new(c);v(a,e,"INC","productionIncome",b,d),v(a,e,"EXP","productionExpenditure",b,d),w(a,e,b,d)})}function y(b){b.data.monthlyStatement=l.reject(b.data.monthlyStatement,function(a){return"farm valuation"===a.source}),l.each(b.models.farmValuations,function(c){var d=e.new(c);if(d.data.request&&d.data.report){var f=d.data.request.legalEntity;l.some(b.models.legalEntities,function(a){return a.uuid===f.uuid})&&(d.data.report.landUseComponents&&l.each(d.data.report.landUseComponents,function(a,c){l.each(a,function(a){var d=l.findWhere(b.data.monthlyStatement,{uuid:c+"-"+a.name});l.isUndefined(d)?b.data.monthlyStatement.push({uuid:c+"-"+a.name,legalEntityUuid:f.uuid,name:c,description:a.name,type:"asset",subtype:"land use",source:"farm valuation",value:a.area*a.valuePerHa}):d.value+=a.area*a.valuePerHa})}),d.data.report.improvements&&l.each(d.data.report.improvements,function(c){var d=a.new(c),e=l.findWhere(b.data.monthlyStatement,{uuid:d.assetKey,type:"asset"}),f=l.findWhere(b.data.assets.improvement,{assetKey:d.assetKey});if(l.isUndefined(e)){if(f&&d.validate()){var g=l.findWhere(b.data.legalEntities,{id:f.legalEntityId});l.some(b.models.legalEntities,function(a){return a.uuid===g.uuid})&&b.data.monthlyStatement.push({uuid:d.assetKey,legalEntityUuid:g.uuid,name:d.title,description:d.description,type:"asset",subtype:d.type,source:"farm valuation",value:d.data.assetValue||0})}}else e.source="farm valuation",e.value=d.data.assetValue}))}})}function z(a,b,c,d){a.data.assetStatement[b]=a.data.assetStatement[b]||[];var e=l.findIndex(a.data.assetStatement[b],function(a){return a.name==c}),f=-1!==e?a.data.assetStatement[b].splice(e,1):{name:c,estimatedValue:0,currentRMV:0,yearlyRMV:[],assets:[]};l.findWhere(f.assets,{assetKey:d.assetKey})||f.assets.push(d),f.estimatedValue+=d.data.assetValue||0,a.data.assetStatement[b].push(f)}function A(a,b){var c="production-credit"==b.type||"rent"==b.type?"short-term":b.type,d="rent"==b.type?"Rent overdue":b.name,e=l.findIndex(a.data.liabilityStatement[c],function(a){return a.name==d}),f=Math.ceil(moment(a.endDate).diff(moment(a.startDate))/12),h=-1!==e?a.data.liabilityStatement[c].splice(e,1):{name:d,currentValue:0,yearlyValues:g(f),liabilities:[]};a.data.liabilityStatement[c]=a.data.liabilityStatement[c]||[],h.currentValue+=b.liabilityInMonth(a.startDate).opening;for(var i=0;f>i;i++){var j=moment.min(moment(a.endDate),moment(a.startDate).add(i,"years").add(11,"months"));h.yearlyValues[i]+=b.liabilityInMonth(j).closing}l.findWhere(h.liabilities,{uuid:b.uuid})||h.liabilities.push(b),a.data.liabilityStatement[c].push(h)}function B(){}function C(a){var b=Math.ceil(moment(a.endDate).diff(moment(a.startDate))/12);a.data.assetStatement.total=l.chain(a.data.assetStatement).values().flatten(!0).reduce(function(a,b){a.estimatedValue+=b.estimatedValue,a.currentRMV+=b.currentRMV,a.yearlyRMV=p(a.yearlyRMV,b.yearlyRMV)},{estimatedValue:0,currentRMV:0,yearlyRMV:g(b)}).value(),a.data.liabilityStatement.total=l.chain(a.data.liabilityStatement).values().flatten(!0).reduce(function(a,b){a.currentValue+=b.currentValue,a.yearlyValues=p(a.yearlyValues,b.yearlyValues)},{currentValue:0,yearlyValues:g(b)}).value()}function D(b){var c=moment(b.startDate),d=moment(b.endDate),e=d.diff(c,"months");b.data.monthlyStatement=l.reject(b.data.monthlyStatement,function(a){return l.contains(["asset","liability"],a.source)}),b.data.capitalIncome={},b.data.capitalExpenditure={},b.data.otherIncome={},b.data.otherExpenditure={},b.data.debtRedemption={},b.data.assetStatement={},b.data.liabilityStatement={},l.each(b.models.assets,function(f){f=a.new(f);var g=l.findWhere(b.data.legalEntities,{id:f.legalEntityId}),h=l.findWhere(b.data.monthlyStatement,{uuid:f.assetKey});if(g&&l.isUndefined(h)){var j=moment(f.data.acquisitionDate),k=moment(f.data.soldDate);if("vme"===f.type&&("Vehicles"===f.data.type?(f.data.assetValue&&j.isBetween(c,d)&&(s(b,"capitalIncome","Vehicle Purchases",e),b.data.capitalIncome["Vehicle Purchases"][c.diff(j,"months")]+=f.data.assetValue),f.data.sold&&f.data.salePrice&&k.isBetween(c,d)&&(s(b,"capitalExpenditure","Vehicle Sales",e),b.data.capitalExpenditure["Vehicle Sales"][c.diff(k,"months")]+=f.data.salePrice)):"Machinery"===f.data.type&&(f.data.assetValue&&j.isBetween(c,d)&&(s(b,"capitalIncome","Machinery & Plant Purchases",e),b.data.capitalIncome["Machinery & Plant Purchases"][c.diff(j,"months")]+=f.data.assetValue),f.data.sold&&f.data.salePrice&&k.isBetween(c,d)&&(s(b,"capitalExpenditure","Machinery & Plant Sales",e),b.data.capitalExpenditure["Machinery & Plant Sales"][c.diff(k,"months")]+=f.data.salePrice))),f.data.assetValue&&(!f.data.sold||!k.isBefore(c)))switch(f.type){case"improvement":case"farmland":z(b,"long-term","Land and fixed improvements",f);break;case"vme":z(b,"medium-term",f.data.type,f);break;case"other":z(b,f.data.liquidityType,f.data.name,f)}angular.forEach(f.liabilities,function(a){var c="rent"===a.type?"capitalExpenditure":"debtRedemption",d="other"!==a.type?i.getTypeTitle(a.type):a.name,f=a.liabilityInRange(b.startDate,b.endDate);s(b,c,d,e),b.data[c][d]=l.map(f,function(a,e){return(a.repayment||0)+(b.data[c][d][e]||0)}),A(b,a)}),b.data.monthlyStatement.push({uuid:f.assetKey,legalEntityUuid:g.uuid,name:f.title,description:f.description,type:"asset",subtype:f.type,source:"asset",value:f.data.assetValue||0})}}),l.each(b.models.liabilities,function(a){a=i.new(a);var c=l.findWhere(b.data.legalEntities,{id:a.legalEntityId}),d=l.findWhere(b.data.monthlyStatement,{uuid:a.uuid});if(c&&l.isUndefined(d)){var f="rent"===a.type?"capitalExpenditure":"debtRedemption",g="other"!==a.type?i.getTypeTitle(a.type):a.name,h=a.liabilityInRange(b.startDate,b.endDate);s(b,f,g,e),b.data[f][g]=l.map(h,function(a,c){return(a.repayment||0)+(b.data[f][g][c]||0)}),A(b,a),b.data.monthlyStatement.push({uuid:a.uuid,legalEntityUuid:c.uuid,name:a.name||"",description:a.description||"",type:"liability",subtype:"other",source:"liability",liability:h})}}),B(b),C(b)}function E(a,b){return l.reduce(a.slice(12*(b-1),12*b),function(a,b){return a+(b||0)},0)}function F(a,b,c,d,e){return l.chain(a.models.liabilities).filter(function(a){return b&&0!=b.length?-1!=b.indexOf(a.type):!0}).reduce(function(a,b){return a+(l.chain(b.liabilityInRange(c,d).slice(12*(e-1),12*e)).pluck("interest").reduce(function(a,b){return a+b},0).value()||0)},0).value()}function G(a,b,c,d,e){return l.chain(a.models.liabilities).filter(function(a){return b&&0!=b.length?-1!=b.indexOf(a.type):!0}).reduce(function(a,b){var f=b.liabilityInRange(c,d).slice(12*(e-1),12*e);return a+(f.length?f[f.length-1].closing||0:0)},0).value()}function H(a,b){return l.reduce(a,function(a,b){l.each(b,function(b,c){a[c]+=b})},b),b}function I(a,b){return l.reduce(a,function(a,b){return H(b,a)},b)}function J(a){var b=moment(a.startDate),c=moment(a.endDate),d=c.diff(b,"months");a.data.summary={},a.data.summary.monthly={unallocatedProductionIncome:I([a.data.unallocatedProductionIncome],g(d)),unallocatedProductionExpenditure:I([a.data.unallocatedProductionExpenditure],g(d)),capitalIncome:I([a.data.capitalIncome],g(d)),capitalExpenditure:I([a.data.capitalExpenditure],g(d)),otherIncome:I([a.data.otherIncome],g(d)),otherExpenditure:I([a.data.otherExpenditure],g(d)),debtRedemption:I([a.data.debtRedemption],g(d)),totalIncome:I([a.data.capitalIncome,a.data.unallocatedProductionIncome,a.data.otherIncome],g(d)),totalExpenditure:I([a.data.capitalExpenditure,a.data.unallocatedProductionExpenditure,a.data.debtRedemption,a.data.otherExpenditure],g(d))},a.data.summary.yearly={unallocatedProductionIncome:[E(a.data.summary.monthly.unallocatedProductionIncome,1),E(a.data.summary.monthly.unallocatedProductionIncome,2)],unallocatedProductionExpenditure:[E(a.data.summary.monthly.unallocatedProductionExpenditure,1),E(a.data.summary.monthly.unallocatedProductionExpenditure,2)],capitalIncome:[E(a.data.summary.monthly.capitalIncome,1),E(a.data.summary.monthly.capitalIncome,2)],capitalExpenditure:[E(a.data.summary.monthly.capitalExpenditure,1),E(a.data.summary.monthly.capitalExpenditure,2)],otherIncome:[E(a.data.summary.monthly.otherIncome,1),E(a.data.summary.monthly.otherIncome,2)],otherExpenditure:[E(a.data.summary.monthly.otherExpenditure,1),E(a.data.summary.monthly.otherExpenditure,2)],debtRedemption:[E(a.data.summary.monthly.debtRedemption,1),E(a.data.summary.monthly.debtRedemption,2)],totalIncome:[E(a.data.summary.monthly.totalIncome,1),E(a.data.summary.monthly.totalIncome,2)],totalExpenditure:[E(a.data.summary.monthly.totalExpenditure,1),E(a.data.summary.monthly.totalExpenditure,2)],productionCapitalInterest:[F(a,["short-term","production-credit"],b,c,1),F(a,["short-term","production-credit"],b,c,2)],mediumTermInterest:[F(a,["medium-term"],b,c,1),F(a,["medium-term"],b,c,2)],longTermInterest:[F(a,["long-term"],b,c,1),F(a,["long-term"],b,c,2)],totalInterest:[F(a,[],b,c,1),F(a,[],b,c,2)],currentLiabilities:[G(a,["short-term","production-credit"],b,c,1),G(a,["short-term","production-credit"],b,c,2)],mediumLiabilities:[G(a,["medium-term"],b,c,1),G(a,["medium-term"],b,c,2)],longLiabilities:[G(a,["long-term"],b,c,1),G(a,["long-term"],b,c,2)],totalLiabilities:[G(a,[],b,c,1),G(a,[],b,c,2)]}}function K(a){for(var b=moment(a.startDate),c=moment(a.endDate),d=c.diff(b,"months"),e=Math.ceil(c.diff(b,"years",!0)),f={opening:0,inflow:0,outflow:0,balance:0,interestPayable:0,interestReceivable:0,closing:0};a.account.monthly.length<d;)a.account.monthly.push(f);for(;a.account.yearly.length<e;)a.account.yearly.push(l.extend(f,{worstBalance:0,bestBalance:0,openingMonth:null,closingMonth:null}));l.each(a.account.monthly,function(b,c){b.opening=0===c?a.account.openingBalance:a.account.monthly[c-1].closing,b.inflow=a.data.summary.monthly.totalIncome[c],b.outflow=a.data.summary.monthly.totalExpenditure[c],b.balance=b.opening+b.inflow-b.outflow,b.interestPayable=b.balance<0&&a.account.interestRateCredit?(b.opening+b.balance)/2*(100*a.account.interestRateCredit/12):0,b.interestReceivable=b.balance>0&&a.account.interestRateDebit?(b.opening+b.balance)/2*(100*a.account.interestRateDebit/12):0,b.closing=b.balance+b.interestPayable+b.interestReceivable}),l.each(a.account.yearly,function(c,d){var e=a.account.monthly.slice(12*d,12*(d+1));c.opening=e[0].opening,c.inflow=n(e,"inflow"),c.outflow=n(e,"outflow"),c.balance=c.opening+c.inflow-c.outflow,c.interestPayable=n(e,"interestPayable"),c.interestReceivable=n(e,"interestReceivable"),c.closing=c.balance+c.interestPayable+c.interestReceivable,c.openingMonth=moment(b).add(d,"years"),c.closingMonth=moment(b).add(d,"years").add(e.length-1,"months").format("MMM-YY");var f=l.max(e,function(a){return a.closing}),g=l.min(e,function(a){return a.closing});c.bestBalance={balance:f.closing,month:moment(c.openingMonth).add(e.indexOf(f),"months").format("MMM-YY")},c.worstBalance={balance:g.closing,month:moment(c.openingMonth).add(e.indexOf(g),"months").format("MMM-YY")},c.openingMonth.format("MMM-YY"),2>c&&(a.data.summary.yearly.productionCapitalInterest[c]+=-c.interestPayable,a.data.summary.yearly.totalInterest[c]+=-c.interestPayable)})}function L(a){a.data.ratios={productionCost:M(a,"totalExpenditure","totalIncome"),netCapital:M(a,"totalAssets","totalLiabilities"),gearing:M(a,"totalLiabilities",["totalAssets","-totalLiabilities"]),debt:M(a,"totalLiabilities","totalAssets"),cashFlowBank:null,cashFlowFarming:null}}function M(a,b,c){function d(b,c){return a.data.summary[c]?l.map(b,function(b){return"-"===b.charAt(0)?(b=b.substr(1),q(a.data.summary[c][b])):a.data.summary[c][b]}):[]}return l.isArray(b)||(b=[b]),l.isArray(c)||(c=[c]),{monthly:o(p(d(b,"monthly")),p(d(c,"monthly"))),yearly:o(p(d(b,"yearly")),p(d(c,"yearly")))}}c.apply(this,arguments),this.docType="business plan",this.data.account=this.data.account||{monthly:[],yearly:[],openingBalance:0,interestRateCredit:0,interestRateDebit:0,depreciationRate:0},this.data.models=this.data.models||{assets:[],farmValuations:[],legalEntities:[],liabilities:[],productionSchedules:[]},this.data.monthlyStatement=this.data.monthlyStatement||[],this.data.adjustmentFactors=this.data.adjustmentFactors||{},this.data.livestockValues=this.data.livestockValues||{breeding:{stockSales:g(12),stockPurchases:g(12)},marketable:{}},j(this,"addLegalEntity",function(a){var b=this,c=l.findWhere(this.models.legalEntities,{uuid:a.uuid});l.isUndefined(c)&&h.new(a).validate()&&(this.models.legalEntities.push(a),angular.forEach(a.assets,function(a){b.addAsset(a)}),d(this))}),j(this,"removeLegalEntity",function(a){this.models.legalEntities=l.reject(this.models.legalEntities,function(b){return b.id===a.id}),this.models.assets=l.reject(this.models.assets,function(b){return b.legalEntityId===a.id}),d(this)}),j(this,"updateProductionSchedules",function(a){var b=moment(this.startDate),c=moment(this.endDate);this.models.productionSchedules=[],angular.forEach(a,function(a){a&&k.new(a).validate()&&(b.isBetween(a.startDate,a.endDate)||b.isBefore(a.endDate)&&c.isAfter(a.startDate))&&this.models.productionSchedules.push(a)},this),x(this),f(this)}),j(this,"addFarmValuation",function(a){var b=l.findWhere(this.models.farmValuations,{documentId:a.documentId});l.isUndefined(b)&&e.new(a).validate()&&(this.models.farmValuations.push(a),y(this),f(this))}),j(this,"removeFarmValuation",function(a){this.models.farmValuations=l.reject(this.models.farmValuations,function(b){return b.id===a.id}),y(this),f(this)}),j(this,"updateLivestockValues",function(){}),j(this,"addAsset",function(b){a.new(b).validate()&&(this.models.assets=l.reject(this.models.assets,function(a){return a.assetKey===b.assetKey}),this.models.assets.push(b instanceof a?b.asJSON():b),D(this),f(this))}),j(this,"removeAsset",function(a){this.models.assets=l.reject(this.models.assets,function(b){return b.assetKey===a.assetKey}),D(this),f(this)}),j(this,"addLiability",function(a){i.new(a).validate()&&(this.models.liabilities=l.reject(this.models.liabilities,function(b){return b.uuid===a.uuid}),this.models.liabilities.push(a instanceof i?a.asJSON():a),D(this),f(this))}),j(this,"removeLiability",function(a){this.models.liabilities=l.reject(this.models.liabilities,function(b){return b.uuid===a.uuid}),D(this),f(this)}),b(this,"startDate",function(){return this.data.startDate}),b(this,"endDate",function(){return this.data.endDate=this.data.startDate?moment(this.data.startDate).add(2,"y").format():this.data.endDate,this.data.endDate}),b(this,"account",function(){return this.data.account}),b(this,"adjustmentFactors",function(){return this.data.adjustmentFactors}),b(this,"models",function(){return this.data.models}),b(this,"monthlyStatement",function(){return this.data.monthlyStatement}),j(this,"recalculateModel",function(){d(this)})}return g(m,c),m.validates({author:{required:!0,length:{min:1,max:255}},docType:{required:!0,equal:{to:"business plan"}},organizationId:{required:!0,numeric:!0},startDate:{required:!0,format:{date:!0}},title:{required:!0,length:{min:1,max:255}}}),m}]);var sdkModelDocument=angular.module("ag.sdk.model.document",["ag.sdk.library","ag.sdk.model.base"]);sdkModelDocument.factory("Document",["inheritModel","Model","privateProperty","readOnlyProperty","underscore",function(a,b,c,d,e){function f(a){b.Base.apply(this,arguments),this.data=a&&a.data||{},c(this,"updateRegister",function(a){this.data=e.extend(this.data,{farmer:e.omit(a,["farms","legalEntities","primaryContact","teams"]),farms:a.farms,legalEntities:e.map(a.legalEntities,function(a){return e.omit(a,["assets","farms"])}),assets:e.chain(a.legalEntities).pluck("assets").flatten().compact().groupBy("type").value(),liabilities:e.chain(a.legalEntities).pluck("liabilities").flatten().compact().value()})}),e.isUndefined(a)||0===arguments.length||(this.author=a.author,this.docType=a.docType,this.documentId=a.documentId,this.id=a.id||a.$id,this.organizationId=a.organizationId,this.title=a.title)}return a(f,b.Base),d(f,"docTypes",{"asset register":"Asset Register","business plan":"Business Plan","emergence report":"Emergence Report","farm valuation":"Farm Valuation","insurance policy":"Insurance Policy","production plan":"Production Plan","progress report":"Progress Report"}),f.validates({author:{required:!0,length:{min:1,max:255}},docType:{required:!0,inclusion:{"in":e.keys(f.docTypes)}},organizationId:{required:!0,numeric:!0}}),f}]);var sdkModelFarmValuationDocument=angular.module("ag.sdk.model.farm-valuation",["ag.sdk.model.asset","ag.sdk.model.document"]);sdkModelFarmValuationDocument.factory("FarmValuation",["Asset","computedProperty","Document","inheritModel","privateProperty",function(a,b,c,d){function e(){c.apply(this,arguments),this.docType="farm valuation"}return d(e,c),e.validates({author:{required:!0,length:{min:1,max:255}},docType:{required:!0,equal:{to:"farm valuation"}},organizationId:{required:!0,numeric:!0}}),e}]);var sdkModelLegalEntity=angular.module("ag.sdk.model.legal-entity",["ag.sdk.library","ag.sdk.model.base"]);sdkModelLegalEntity.factory("LegalEntity",["inheritModel","Model","readOnlyProperty","underscore",function(a,b,c,d){function e(a){b.Base.apply(this,arguments),this.data=a&&a.data||{},d.isUndefined(a)||0===arguments.length||(this.addressCity=a.addressCity,this.addressCode=a.addressCode,this.addressDistrict=a.addressDistrict,this.addressStreet=a.addressStreet,this.email=a.email,this.fax=a.fax,this.id=a.id||a.$id,this.mobile=a.mobile,this.name=a.name,this.organizationId=a.organizationId,this.registrationNumber=a.registrationNumber,this.telephone=a.telephone,this.type=a.type,this.uuid=a.uuid)
